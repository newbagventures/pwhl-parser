...
while( ( $line = fgetcsv( $fh ) ) !== FALSE ) {
    ...
    if( $i == 0 ) {
     ...
     if( ($line[4] != "") && ($i > 0) ) {
        ...
        echo "<p style=\"color: red;\">Record " . ($i) . ". Found $total_elements_in_details in details variable for ".$line[0] ." <a href=\"https://shop.thepwhl.com/products/". $line[1] ."\">" . $line[1] . " _target=\"blank\"</a>.</p>\n";
